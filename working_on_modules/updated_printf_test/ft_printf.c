...
/*   Updated: 2024/01/10 21:50:59 by achappui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	choose_printer(va_list args, t_options *o)
{
	if (o->spe == '%')
		...
		return (ft_print_uint(va_arg(args, unsigned int), o));
	else if (o->spe == 'x')
		return (ft_print_uint(va_arg(args, unsigned int), o));
	else if (o->spe == 'X')
		return (ft_print_uint(va_arg(args, unsigned int), o));
	else if (o->spe == 'p')
		return (ft_print_ptr(va_arg(args, uintptr_t), o));
	else if (o->spe == 'f')
		return (ft_print_float(va_arg(args, float), o));
	return (-1);
}
