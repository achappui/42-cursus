...
unsigned	Date::getYear(void) const {return (std::stoi(m_date.substr(0, 4)));}
unsigned	Date::getMonth(void) const {return (std::stoi(m_date.substr(5, 2)));}
unsigned	Date::getDay(void) const {return (std::stoi(m_date.substr(8, 2)));}
